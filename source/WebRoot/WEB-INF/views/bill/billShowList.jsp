	...
	<body>
		...
		<div class="container">
			...
			<div class="panel panel-primary panel-mo">
				<div class="panel-heading">
					当前会员账户信息列表&nbsp;&nbsp;&nbsp;&nbsp;
					<a type="btn" class="btn btn-success pull-right btn-sm btn-mo" href="<c:url value='/bill/${vipid}/mg/show'/>">管理账单记录</a>
				</div>
				<div class="panel-body">
					<!-- 被查看账单的vip会员的账单信息  开始-->	
					<table class="table table-mo table-bordered table-hover" id="acc-table">
						...
						<tbody>
							<tr class="non_show_tr warning"><td colspan="7" class="non_show_td">正在查询</td></tr>
						</tbody>
					</table>
					<!-- 被查看账单的vip会员的账单信息  结束-->	
					<!--分页区域 start-->
		...
		<script type="text/javascript">
			...
			function appendTbodyVipConts(d){
				var tr_c = '';
				//var ditems = d.items;
				var flag_arr = ['name','card','phone','birth','createTime','updateTime','email','memo'];
				if(d && d.id){
					...
					tr_c += '<tr class="non_show_tr warning"><td colspan="7" class="non_show_td">无查询记录</td></tr>';
				}
