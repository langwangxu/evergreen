...
<body>
	...
	<div class="container">
		<div class="panel panel-primary panel-mo">
			...
			<div class="panel-body">
				<form action="${context}/bill/save" onsubmit="return billSubmit()" class="form-horizontal" method="POST"> 
					<div class="form-group">
						...
						<input type="hidden" name="consumeTime" id="consumeTime" value="" /><br/>
				  	</div>
					<div class="form-group">
					    <label for="consumerNum" class="col-sm-3 control-label">用餐人数</label>
					    <div class="col-sm-7 input-group">
					      <input type="text" id="consumerNum" name="consumerNum" class="form-control" placeholder="输入数字"/>
					    </div>
				  	</div>
					<div class="form-group">
					    <label for="dinnerType" class="col-sm-3 control-label">用餐类型</label>
					    <div class="col-sm-7 input-group" >
						    <select class="form-control" name="dinnerType">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			var initDate = timeStamp2String(new Date(),'d');
			$('div.form_date_d input#consumeTime_bak').val(initDate);
			$('input#consumeTime').val(initDate);
		});
	</script>
</body>
</html>
