	...
	<body>
		...
		<div class="container">
			...
			<div class="panel panel-primary panel-mo">
				<div class="panel-heading">
					VIP会员信息列表&nbsp;&nbsp;&nbsp;&nbsp;
					<a type="btn" class="btn btn-success pull-right btn-sm btn-mo" href="<c:url value='/vip/mg/list'/>">管理VIP记录</a>
				</div>
				<div class="panel-body">
					<table class="table table-mo table-bordered table-hover">
						...
						<tbody>
							<tr class="non_show_tr warning"><td colspan="9" class="non_show_td">无查询记录</td></tr>
						</tbody>
					</table>
					<!--分页区域 start-->
		...
		<script type="text/javascript">
			...
			function freshMsg(){
				...
				var msg_show = '<tr class="non_show_tr warning"><td colspan="9" class="non_show_td"><i class="fa fa-3x fa-blue fa-spinner fa-pulse"></i></td></tr>';
				...
				if(ditems && ditems.length>0){
					$.each(ditems,function(i,di){
						...
						$.each(flag_arr,function(f,item){
							...
							if(item == 'name'){
								var diid = di['id'];
								var acurl = '<c:url value="/bill/'+diid+'/show"/>';
								divv = '<a href="'+acurl+'" title="点击查看该vip会员的账单信息">'+di[item]+'</a>';
							}
							td_c += '<td>'+divv+'</td>';
						});
						tr_c += '<tr>'+td_c+'</tr>';
					...
					tr_c += '<tr class="non_show_tr warning"><td colspan="9" class="non_show_td">无查询记录</td></tr>';
				}
				$('table.table-mo tbody').remove();
